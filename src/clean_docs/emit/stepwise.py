"""Project a clean-docs manifest into a docs-only stepwise skill package."""
...
def _config(
    *,
    ...
    return {
        ...
        "description": "Keep repository documentation true to its source with clean-docs",
        "tags": ["documentation", "clean-docs"],
        "cli": cli,
...
def _description(bound_docs: list[str]) -> str:
    ...
    return (
        ...
        "Use this package to audit the documentation corpus, repair source-bound regions, and "
        "verify that no drift remains. Each step names its command and the condition for moving "
        "to the next step.\n\n"
...
def _step_audit() -> str:
    return (
        ...
        "## Status\n\n"
        "Emit: `clean-docs: auditing documentation`.\n\n"
        "## Action\n\n"
...
def _step_repair(bound_docs: list[str]) -> str:
    ...
    return (
        ...
        "## Status\n\n"
        "Emit: `clean-docs: repairing bound regions`.\n\n"
        "## Action\n\n"
