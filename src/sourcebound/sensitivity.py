...
from sourcebound.claims import extract_source_facts, scan_source_claims
from sourcebound.errors import ConfigurationError
from sourcebound.models import SourceClaimCheck
...
def _mutate_identifier(
    ...
    replacement_value = f"{member}__sourcebound_probe"
    existing = {
        candidate.value
