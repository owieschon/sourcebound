...
from sourcebound.applicability import ROLE_DESCRIPTIONS
from sourcebound.audit import AUDIT_BASELINE_PATH, audit, write_audit_baseline
...
from sourcebound.changed import check_changed, render_sarif
from sourcebound.claims import claim_binding_results, scan_source_claims
from sourcebound.context import compile_context
from sourcebound.doctor import build_diagnostic_bundle
from sourcebound.emit import emit_llms_txt, emit_stepwise_skill
from sourcebound.engine import drive, evaluate, write_results
from sourcebound.evaluation import run_evaluation, write_evaluation_history
from sourcebound.errors import SourceboundError, ConfigurationError
from sourcebound.execution import ExecutionPolicy
from sourcebound.explain import explain
...
from sourcebound.impact import build_impact_plan, render_impact_plan
...
from sourcebound.review_ledger import validate_review_event_ledger
from sourcebound.review_ledger import (
    initialize_review_event_ledger,
    write_review_event_ledger,
)
from sourcebound.residue import LOCAL_CONFIG_NAME, load_local_residue_rules
from sourcebound.sensitivity import (
    decode_json_object,
    evaluate_binding_sensitivity,
    load_json_object,
)
from sourcebound.standard import compile_standard, pack_matches_standard, write_pack
...
def _parser() -> argparse.ArgumentParser:
    ...
    for command in ("build", "check"):
        ...
        item.add_argument(
            "--output", type=Path, default=Path("src/sourcebound/standards/default.json")
        )
    return parser
...
def main(argv: list[str] | None = None) -> int:
    ...
    except (SourceboundError, OSError, ValueError):
